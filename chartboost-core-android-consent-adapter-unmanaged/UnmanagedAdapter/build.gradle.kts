...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            "String",
            "CHARTBOOST_CORE_UNMANAGED_CONSENT_ADAPTER_VERSION",
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("UnmanagedConsentAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                artifactId = "chartboost-core-consent-adapter-unmanaged"
                ...
                pom {
                    name.set("Chartboost Core Consent Adapter Unmanaged")
                    ...
                    scm {
                        val gitUrl = "https://github.com/ChartBoost/chartboost-core-android-consent-adapter-unmanaged"
                        url.set(gitUrl)
