...
android {
    namespace = "com.chartboost.core.consent.googleusermessagingplatform"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "1.3.0.0.0"

        buildConfigField(
            "String",
            "CHARTBOOST_CORE_GOOGLE_USER_MESSAGING_PLATFORM_ADAPTER_VERSION",
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("GoogleUserMessagingPlatformAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                artifactId = "chartboost-core-consent-adapter-google-user-messaging-platform"
                ...
                pom {
                    name.set("Chartboost Core Consent Adapter Google")
