...
class ChartboostMediationFullscreenAdQueueTest {
    ...
    fun setUp() {
        ...
        mockkObject(HeliumSdk.chartboostMediationInternal)
        every { HeliumSdk.chartboostMediationInternal.initializationStatus } returns HeliumSdk.ChartboostMediationInitializationStatus.INITIALIZED
    ...
    fun `start queue should not run before SDK has initialized`() {
        every { HeliumSdk.chartboostMediationInternal.initializationStatus } returns HeliumSdk.ChartboostMediationInitializationStatus.IDLE
