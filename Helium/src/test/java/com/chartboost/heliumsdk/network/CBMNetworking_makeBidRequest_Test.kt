...
import com.chartboost.heliumsdk.network.ChartboostMediationNetworkingTest.Companion.BANNER_LOAD_ID
import com.chartboost.heliumsdk.network.ChartboostMediationNetworkingTest.Companion.INTERSTITIAL_IMPRESSION_DEPTH
import com.chartboost.heliumsdk.network.ChartboostMediationNetworkingTest.Companion.INTERSTITIAL_LOAD_ID
...
import com.chartboost.heliumsdk.network.ChartboostMediationNetworkingTest.Companion.REWARDED_LOAD_ID
...
fun ChartboostMediationNetworkingTest.`verify banner bid request success`() = runTest {
    ...
    val response = ChartboostMediationNetworking.makeBidRequest(
...
fun ChartboostMediationNetworkingTest.`verify banner bid request failure due to json parsing`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify banner bid request failure due to http code`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify interstitial bid request success`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify interstitial bid request failure due to json parsing`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify interstitial bid request failure due to http code`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify rewarded bid request success`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify rewarded bid request failure due to json parsing`() = runTest {
...
fun ChartboostMediationNetworkingTest.`verify rewarded bid request failure due to http code`() = runTest {
