...
fun ChartboostMediationNetworkingTest.`verify trackClick`() = runTest {
    ...
    val response = ChartboostMediationNetworking.trackClick(
    ...
    val expectedUrl = Endpoints.Sdk.Event.CLICK.endpoint
