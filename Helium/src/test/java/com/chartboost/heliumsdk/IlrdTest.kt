...
open class IlrdTest {
    ...
    private lateinit var impressionDataSlot: CapturingSlot<HeliumImpressionData>
    ...
    fun onIlrdReceived_shouldFireOnImpressionForAllObservers() {
        val mockObserver2 = mockk<HeliumIlrdObserver>()
        val impressionDataSlot2 = slot<HeliumImpressionData>()
