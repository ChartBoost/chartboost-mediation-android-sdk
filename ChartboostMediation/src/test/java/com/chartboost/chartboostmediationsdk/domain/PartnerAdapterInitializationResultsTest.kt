...
import com.chartboost.chartboostmediationsdk.PartnerAdapterInitializationResults
...
class PartnerAdapterInitializationResultsTest {
    /**
    ...
    @Before
    fun setUp() {
        ChartboostMediationNetworkingTest.setMockEnvironment()

        getPublicPayloadMethod =
            PartnerAdapterInitializationResults::class.java
                .getDeclaredMethod(
                    "getPublicPayload",
        ...
        publicPayload =
            getPublicPayloadMethod.invoke(
                PartnerAdapterInitializationResults(),
                internalPayload,
            ) as JSONObject
    }
