...
class ChartboostMediationJsonTest {
    ...
    @Test
    fun `make sure chartboostMediationJson has the correct flags set`() {
        assertTrue(ChartboostMediationJson.configuration.isLenient)
        assertTrue(ChartboostMediationJson.configuration.ignoreUnknownKeys)
        assertTrue(ChartboostMediationJson.configuration.encodeDefaults)

        assertFalse(ChartboostMediationJson.configuration.explicitNulls)
    }
