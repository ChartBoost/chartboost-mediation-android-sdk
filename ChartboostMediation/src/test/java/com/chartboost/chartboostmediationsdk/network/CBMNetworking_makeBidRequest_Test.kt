...
import com.chartboost.chartboostmediationsdk.network.ChartboostMediationNetworkingTest.Companion.BANNER_IMPRESSION_DEPTH
import com.chartboost.chartboostmediationsdk.network.ChartboostMediationNetworkingTest.Companion.INTERSTITIAL_IMPRESSION_DEPTH
import com.chartboost.chartboostmediationsdk.network.ChartboostMediationNetworkingTest.Companion.RATE_LIMIT_HEADER_VALUE
import com.chartboost.chartboostmediationsdk.network.ChartboostMediationNetworkingTest.Companion.REWARDED_IMPRESSION_DEPTH
...
fun ChartboostMediationNetworkingTest.`verify banner bid request success`() =
    runTest {
        ...
        val expectedUrl = Endpoints.Auction.AUCTION_NONTRACKING.endpoint
