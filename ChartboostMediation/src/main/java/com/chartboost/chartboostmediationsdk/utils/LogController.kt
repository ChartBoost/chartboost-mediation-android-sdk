 ...
 * @suppress
 *
 * Logging system for the Chartboost Mediation SDK that handles both client-side logging and metrics data reporting.
 */
object LogController {
    ...
    enum class LogLevel(
        ...
        companion object {
             ...
             */
            fun fromInt(logLevelInt: Int?): LogLevel = values().find { it.value == logLevelInt } ?: VERBOSE
        }
    }
     ...
     * ordinal [LogLevel]. If set to [LogLevel.DISABLED], all logs are suppressed.
     */
    ...
    /**
     * Prefix for all Chartboost Mediation log messages.
     */
    internal const val TAG = "[ChartboostMediation]"
