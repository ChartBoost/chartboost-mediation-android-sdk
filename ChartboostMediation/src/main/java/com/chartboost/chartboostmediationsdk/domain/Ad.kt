...
import com.chartboost.chartboostmediationsdk.ad.ChartboostMediationAd

/**
 * @suppress
 */
class Ad(
    ad: ChartboostMediationAd,
) {
    val adIdentifier: AdIdentifier
    var chartboostMediationAd: ChartboostMediationAd
    ...
    init {
        adIdentifier = AdIdentifier(ad.getAdType(), ad.placement)
        chartboostMediationAd = ad
        state = State.NEW
    }
}
