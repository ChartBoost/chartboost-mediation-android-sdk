...
import com.chartboost.chartboostmediationsdk.domain.serializers.KeywordsSerializer
...
class Keywords {
     ...
     */
    fun remove(key: String): String? = keywords.remove(key)

    /**
     * Return an immutable copy of the keywords data.
     * @return an immutable copy of the keywords data.
     */
    fun get(): Map<String, String> = Collections.unmodifiableMap(keywords)
