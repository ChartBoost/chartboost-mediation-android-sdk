...
object ChartboostMediationFullscreenAdQueueManager {
     ...
     * @param placement The Chartboost Mediation placement [String] to create an ad queue.
     *
    ...
    fun queue(
        ...
        placementToFullscreenAdQueues.getOrPut(placement) {
            ChartboostMediationFullscreenAdQueue(context, placement)
        }
}
