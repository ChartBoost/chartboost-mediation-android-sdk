...
android {
    namespace = "com.chartboost.core.consent.reference"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "1.1.0.0.0"

        buildConfigField(
            "String",
            "CHARTBOOST_CORE_REFERENCE_CONSENT_ADAPTER_VERSION",
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("ReferenceConsentAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                artifactId = "chartboost-core-consent-adapter-reference"
                ...
                pom {
                    name.set("Chartboost Core Consent Adapter Reference")
                    ...
                    scm {
                        val gitUrl = "https://github.com/ChartBoost/chartboost-core-android-consent-adapter-reference"
                        url.set(gitUrl)
